...
function(bloom_configure_quality_tools)
    ...
    if(BLOOM_ENABLE_CLANG_TIDY)
        ...
        set(
            ...
            "${BLOOM_CLANG_TIDY_EXECUTABLE};--checks=${BLOOM_CLANG_TIDY_CHECKS};--warnings-as-errors=*;--header-filter=^${PROJECT_SOURCE_DIR}/(apps|src|tests|tools)/;--exclude-header-filter=/third_party/"
        )
