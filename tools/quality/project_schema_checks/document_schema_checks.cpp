...
void checkProjectSchemas(const std::filesystem::path& repositoryRoot) {
    validateDocumentSchemaV1_5(json::parseFile(repositoryRoot / "schemas/project/document-1.5.schema.json"));
    validateManifestSchemaV1_5(json::parseFile(repositoryRoot / "schemas/project/manifest-1.5.schema.json"));
