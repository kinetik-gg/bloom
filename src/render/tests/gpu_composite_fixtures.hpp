...
[[nodiscard]] inline std::optional<ImageWindow> window(const std::int64_t originX,
...
[[nodiscard]] inline std::optional<Rgba32f> pixel(const float red, const float green,
...
[[nodiscard]] inline std::optional<Rgba32fImageDescriptor>
descriptor(const ImageWindow dataWindow, const ImageWindow displayWindow) {
