...
constexpr auto kColors = std::to_array<ColorEntry>({
    ...
    {Color::Label1, 0xD97C7CU}, {Color::Label2, 0xD9A66CU},
    {Color::Label3, 0xC9C76BU}, {Color::Label4, 0x83BD84U},
    {Color::Label5, 0x68BABAU}, {Color::Label6, 0x799ED2U},
    {Color::Label7, 0xAA8ACCU}, {Color::Label8, 0xCE89B4U},
