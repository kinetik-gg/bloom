...
// Umbrella header (task F1, item F0). The timeline, properties, and assets editors that all lived in
// one pair of files now own a header and a translation unit each, and the shared authoring truth
