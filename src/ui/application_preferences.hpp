...
//
// Internal to bloom_ui on purpose (src/ui, not src/ui/include/bloom/ui), matching
// properties_sections.hpp's precedent: no target outside bloom_ui has business reading global
