...
void PropertiesEditor::buildTextSection(QVBoxLayout* layout) {
    ...
    // Keep the historical object available to existing automation while the visible Font row is
    // now generated by the parameter registry below this handcrafted source group.
