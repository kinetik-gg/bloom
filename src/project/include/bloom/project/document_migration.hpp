...
[[nodiscard]] MigrationStepOutcome migrateLayerTimelineV1_4(const JsonValue& root,
                                                            std::pmr::memory_resource* resource,
                                                            std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateMergesV1_5(const JsonValue& root,
                                                     std::pmr::memory_resource* resource,
                                                     std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateContentBoundsV1_6(const JsonValue& root,
                                                            std::pmr::memory_resource* resource,
                                                            std::pmr::vector<char>& output);
...
migrateAnimationComponentsV1_8(const JsonValue& root, std::pmr::memory_resource* resource,
                               std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateImagesV1_9(const JsonValue& root,
                                                     std::pmr::memory_resource* resource,
                                                     std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateAudioV1_10(const JsonValue& root,
                                                     std::pmr::memory_resource* resource,
                                                     std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateKeyframeHandlesV1_11(const JsonValue& root,
                                                               std::pmr::memory_resource* resource,
                                                               std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateLayerParentingV1_12(const JsonValue& root,
                                                              std::pmr::memory_resource* resource,
                                                              std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migratePathsV1_13(const JsonValue& root,
                                                     std::pmr::memory_resource* resource,
                                                     std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateTextCapabilityV1_14(const JsonValue& root,
                                                              std::pmr::memory_resource* resource,
                                                              std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome
migrateAssetOrganizationV1_15(const JsonValue& root, std::pmr::memory_resource* resource,
                              std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateVideoV1_16(const JsonValue& root,
                                                     std::pmr::memory_resource* resource,
                                                     std::pmr::vector<char>& output);
...
migrateWorkingColorSpaceV1_18(const JsonValue& root, std::pmr::memory_resource* resource,
                              std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome
migrateAssetInputColorSpaceV1_19(const JsonValue& root, std::pmr::memory_resource* resource,
                                 std::pmr::vector<char>& output);
[[nodiscard]] MigrationStepOutcome migrateLutAssetsV1_20(const JsonValue& root,
                                                         std::pmr::memory_resource* resource,
                                                         std::pmr::vector<char>& output);
inline constexpr std::array kProductionDocumentMigrationSteps{
    ...
    MigrationStepDescriptor{{1, 9}, {1, 10}, migrateImagesV1_9},
    MigrationStepDescriptor{{1, 10}, {1, 11}, migrateAudioV1_10},
    MigrationStepDescriptor{{1, 11}, {1, 12}, migrateKeyframeHandlesV1_11},
    MigrationStepDescriptor{{1, 12}, {1, 13}, migrateLayerParentingV1_12},
    MigrationStepDescriptor{{1, 13}, {1, 14}, migratePathsV1_13},
    ...
    MigrationStepDescriptor{{1, 19}, {1, 20}, migrateAssetInputColorSpaceV1_19},
    MigrationStepDescriptor{{1, 20}, {1, 21}, migrateLutAssetsV1_20}};
