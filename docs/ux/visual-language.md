...
| `BorderActive` | `#444444` | A neutral hover/drag border on navigator-style controls |
| `Accent` | `#0C8CE9` | Selection, focus, the active-panel border, the playhead, and the primary action |
