...
The GRAMMAR-2 fixture renders the real MainWindow with Viewer, Nodes, Timeline, Assets and
...
Normal golden runs write `build/grammar2-window-dpr1.png` (1920 × 1200) and
`build/grammar2-window-dpr15.png` (2880 × 1800). The references approve the status text row, complete sidebar, viewer work area and tools,
